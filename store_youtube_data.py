...
# parameters
bucket_uri = 's3://youtube-etl-data'
...
# s3_output_path_videos = f'{bucket_uri}/output/videos/'
# s3_output_path_stats = f'{bucket_uri}/output/video_stats/'
# glueContext.write_dynamic_frame.from_options(
#     frame=videos_dynamic_frame,
#     connection_type="s3",
#     connection_options={
#         "path": s3_output_path_videos
#     },
#     format="csv",
#     format_options={
#         "separator": ",",        # Specify delimiter (default is comma)
#         "quoteChar": "\""        # Specify quote character (default is double-quote)
#     }
# )
